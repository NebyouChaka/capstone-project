...
import capstone.project.recipes.database.entity.User; // Import the User class from jakarta.persistence
import capstone.project.recipes.database.dao.UserDAO;
import capstone.project.recipes.database.dao.UserRoleDAO;
