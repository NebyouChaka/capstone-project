<div class="pg-footer">
    <footer class="footer sticky-footer">
      ...
      <div class="footer-content">
        <div class="footer-content-column">
          <div class="footer-logo">
            <a class="footer-logo-link" href="#">
              <span class="hidden-link-text">The Recipes</span>
              <h1>The Recipes</h1>
            </a>
          </div>
          <div class="footer-menu">
            ...
            <ul id="menu-get-started" class="footer-menu-list">
              ...
              <li class="menu-item menu-item-type-post_type menu-item-object-product">
                <a href="#">Register for Online Cooking class</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="footer-content-column">
          <div class="footer-menu">
            <h2 class="footer-menu-name"> The recipes.com</h2>
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="#" target="_self"> ©2023. | Designed By: Nebyou Chaka. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
